...
import BasicTableLeaveCategory from "../../components/tables/BasicTables/BasicTableLeaveCategory";
...
export default function LeaveCategory() {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Leave Category" />
      ...
      <div className="space-y-6">
        ...
        <ComponentCard title="All Leave Category Table">
