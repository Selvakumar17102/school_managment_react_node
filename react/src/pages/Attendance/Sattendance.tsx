...
import BasicTableSattendance from "../../components/tables/BasicTables/BasicTableSattendance";
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <ComponentCard title="All Student">
        <div className="flex justify-between items-center mb-4">
            <Link
                to="/addStudentAttendance"
