...
export default function ViewUattendanceDetail() {
    ...
    if (!user || Object.keys(attendance).length === 0) return <p>Loading...</p>;
    ...
    <div className="p-4">
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="text-sm text-right">
          Dashboard / <span className="text-blue-600">User Attendance</span> / <span className="font-semibold">View</span>
        </div>
      </div>
