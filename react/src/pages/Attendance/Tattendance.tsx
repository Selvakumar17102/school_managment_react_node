...
import BasicTableTattendance from "../../components/tables/BasicTables/BasicTableTattendance";
...
export default function Tattendance() {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Teacher Attendance" />
      ...
      <div className="space-y-6">
        ...
        <ComponentCard title="All Teacher">
        <div className="flex justify-between items-center mb-4">
            <Link
                to="/addTeacherAttendance"
