...
import BasicTableSyllabus from "../../components/tables/BasicTables/BasicTableSyllabus";
...
export default function Syllabus() {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Syllabus" />
      ...
      <div className="space-y-6">
        ...
        <ComponentCard title="All Syllabus Table">
